...
slug: linux-home-server-setup-part1
date: 2025-03-17 18:56:00 +09:00
last_modified_at: 2025-03-17 18:56:00 +09:00
categories: [Server, Home Server]
tags: [linux, ubuntu, home-server]
image: "/assets/img/title/server/home_server/part_1.png"
redirect_from:
    - /posts/리눅스-기반의-홈-서버-구축하기-(1)/
    - /posts/%EB%A6%AC%EB%88%85%EC%8A%A4-%EA%B8%B0%EB%B0%98%EC%9D%98-%ED%99%88-%EC%84%9C%EB%B2%84-%EA%B5%AC%EC%B6%95%ED%95%98%EA%B8%B0-(1)/
---
...
{% include series/linux-home-server-setup.html %}
...
부팅 USB 만드는 방법에 대해서는 **[Ventoy로 부팅 USB 만들기](https://devpro.kr/posts/ventoy-bootable-usb/)** 포스트를 참고해주세요.  
