...
slug: github-blog-setup-part4
redirect_from:
    - /posts/GitHub-블로그-만들기-(4)/
    # - /posts/Github-%EB%B8%94%EB%A1%9C%EA%B7%B8-%EB%A7%8C%EB%93%A4%EA%B8%B0-(4)/
...
image: "/assets/img/title/blog/github_blog/logo.png"
---
...
{% include series/github-blog-setup.html %}
...
만약 **`git add`** 과정에서 아래와 같은 경고가 발생한다면 [LF will be replaced by CRLF 경고 해결](https://devpro.kr/posts/git-crlf-warning/) 를 참고해주세요.  
```shell
